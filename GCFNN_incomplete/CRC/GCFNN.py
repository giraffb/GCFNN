...
class specific_encoder(nn.Module):
    ...
    def __init__(self, input_dim, output_dim, num_layers, hidden_dim, dropout):
        ...
        self.gc2 = GraphConvolution(input_dim+hidden_dim, hidden_dim)
        #self.gc3 = GraphConvolution(hidden_dim, output_dim)
        self.gat3 = GraphAttentionLayer(2*hidden_dim, output_dim)
